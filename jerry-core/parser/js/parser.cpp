...
{
  jsp_stack_init ();
  dumper_set_generate_bytecode (parse_mode == PARSE_MODE_DUMP);
                      ...
                      jsp_parse_mode_t parse_mode)
{
  ...
  if (r == 0)
  {
    ...
    jsp_parse_source_element_list (parse_mode);
...
parser_parse_script (const jerry_api_char_t *source, /**< source script */
                     ...
                     const bytecode_data_header_t **out_bytecode_data_p, /**< out: generated byte-code array
                                                                          *  (in case there were no syntax errors) */
                     jsp_parse_mode_t parse_mode) /**< parsing mode */
{
  return parser_parse_program (source, source_size, false, false, out_bytecode_data_p, NULL, parse_mode);
} /* parser_parse_script */
